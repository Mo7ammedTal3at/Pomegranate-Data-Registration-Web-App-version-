...
namespace NoorEl7abeebCompanyWebApp
{
    ...
    public class ApplicationUserManager : UserManager<Manager>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Manager>(context.Get<ApplicationDbContext>()));
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider = 
                    new DataProtectorTokenProvider<Manager>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    }
